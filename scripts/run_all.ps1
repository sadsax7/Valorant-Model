...
Write-Host "[2/5] Entrenando modelo" -ForegroundColor Cyan
...
Write-Host "[3/5] Exportando bloque de test a CSV" -ForegroundColor Cyan
...
Write-Host "[4/5] Generando gráficas" -ForegroundColor Cyan
